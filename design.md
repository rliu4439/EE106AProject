...
We broke our goals down into several tasks we needed to perform:
 ...
 - Use computer vision to detect the object and return the bounding boxs.
...
### Method Design
 ...
 - Two methods are used to obtain the waypoints:
    ...
    - Fix three y-oordinates, then average the x coordinates to get three way points.
