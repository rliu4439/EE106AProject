...
def drive(cfg, model_path=None, use_joystick=False, ee106a=False, model_type=None, camera_type='single', meta=[] ):
    '''
    ...
    V.add(TestImage(), inputs=['user/mode'], outputs=['run_pilot'])
    ...
    if "coral" in model_type:
        ...
        inf_input = 'cam/normalizedrecording/cropped'
    ...
    class DriveMode:
        def run(self, mode, 
            ...
            if mode == 'user':
                print('user') 
                print('user angle',user_angle,"user_throttle",user_throttle)
