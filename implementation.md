...
- Get 2D way points:
  - 1st method
    ...
    <img src="images/pasted image 0.png" width="200" height="auto" style="display:block; margin: 0 auto" ><img src="images/line.png" width="200" height="auto" style="display:block; margin: 0 auto" ><img src="images/point.png" width="200" height="auto" style="display:block; margin: 0 auto" >
  - 2nd method
    - Using filter function from OpenCV to extract the red(color of the lane) region from the raw image based on  HSV space.
